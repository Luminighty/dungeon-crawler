 ...
 * @author Luminight
 */
public class PickupBoat extends PickupItem {

	private static final int defaultAliveTime = -1;
	public static final String sprite = "boat";

	public PickupBoat(int x, int y) {
		super(x, y, sprite, defaultAliveTime);
	}

	public PickupBoat(int x, int y, int aliveTime) {
